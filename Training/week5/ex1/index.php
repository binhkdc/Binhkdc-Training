...
<div class="container">
    <div class="">
        <form action="search.php" method="post">
            <input type="text" class="w-25" placeholder="Nhập từ khóa tìm kiếm" name="search" required/>
        ...
        <?php while ($row = mysqli_fetch_array($query)) { ?>
            <tr>
                ...
                <td class="border">
                    ...
                    <a class="btn btn-danger" id="delete_button-1" href="delete.php?id=<?php echo $row['id']; ?>"
                       role="button">Delete</a>
                    <button hidden type="button" class="btn btn-danger" data-bs-toggle="modal"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a class="btn btn-danger" id="delete_button_1"
